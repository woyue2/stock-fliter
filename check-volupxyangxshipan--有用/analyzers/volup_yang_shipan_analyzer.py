...
# POS:    check-volupxyangxshipan/analyzers/volup_yang_shipan_analyzer.py（Phase 6 从 pipeline.py 提取）
# -*- coding: utf-8 -*-
"""
VolUp x Yang x Shipan分析模块
...
def evaluate_stock(
    ...
    return {
        ...
        "tag":           tag,
        "is_hit":        is_hit,
        "signal":        "VolUp x Yang x Shipan系统" if return_all else "昨放量+今阳线",
    }, None
