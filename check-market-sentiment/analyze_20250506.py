...
（使用 stocks_index/2025-05-05 中的股票列表）
"""
import sys
...
def main():
    ...
    print("  (使用 stocks_index/2025-05-05 中的股票列表)")
    print("=" * 70)
    
    # 设置路径
    base_dir = Path(__file__).resolve().parent
    stocks_list_file = base_dir.parent / "get-data" / "data" / "stocks_index" / "2025-05-05" / "stocks_index.csv"
