...
if results:
    ...
    df['max_seq'] = df[['daily_count', 'weekly_count', 'monthly_count']].max(axis=1)
    df_top = df.nlargest(10, 'max_seq')

    print(df_top[['code', 'name', 'latest_price', 'daily_count', 'weekly_count', 'monthly_count']].to_string(index=False))
