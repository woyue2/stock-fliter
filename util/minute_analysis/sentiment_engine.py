...
# INPUT:  List[Dict] — 股票分钟数据列表（含 code/data/pattern/returns 字段）
# OUTPUT: Dict        — 完整聚合情绪数据（distribution/morning_afternoon/intensity/volume/signal）
# POS:    util/minute_analysis/sentiment_engine.py（迁移自 check-market-sentiment/sentiment_analyzer/）
"""
Sentiment Engine
情绪计算核心模块
"""
