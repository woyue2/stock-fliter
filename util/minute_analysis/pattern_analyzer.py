...
# INPUT:  pd.Series — 单股 OHLC 行 / pd.DataFrame — 全市场数据
# OUTPUT: Tuple[str, str, Dict] / Dict — 形态代码/名称/详细指标，市场分析结果
# POS:    util/minute_analysis/pattern_analyzer.py（迁移自 check-market-sentiment/）
# -*- coding: utf-8 -*-
"""
经典走势形态分析器
