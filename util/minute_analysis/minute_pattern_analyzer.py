...
# INPUT:  pd.DataFrame — 分钟级数据 / Dict[str, DataFrame] — 市场数据
# OUTPUT: Dict — 形态分析结果（vector/features/pattern_code/pattern_name/similarities/市场分布）
# POS:    util/minute_analysis/minute_pattern_analyzer.py（迁移自 check-market-sentiment/）
# -*- coding: utf-8 -*-
"""
分钟级走势形态分析器 - 全新方法
