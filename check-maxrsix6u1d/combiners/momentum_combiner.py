...
# INPUT:  trend_result, steady_result, grid_result
# OUTPUT: Dict of filtered DataFrame by combiners
# POS:    check-maxrsix6u1d/combiners/momentum_combiner.py
# -*- coding: utf-8 -*-
"""
6U1D动量组合器 (Momentum Combiner)
...
from analyzers.grid_analyzer import bollinger_bands, volume_ratio
...
class MomentumCombiner:
    ...
    COMBINATIONS = [
        # ========== 原版6U1D指标（严格6连阳）==========
        # 完整组合 134
        ("6up", "momentum_134_6", "6U1D条件2（连续6天阳线）", True, True, True, "1(MA排列) + 3(趋势分析) + 4(网格测试)"),
        ("6up1down", "momentum_134_61", "6U1D条件1（近10天6涨1跌）", True, True, True, "1(MA排列) + 3(趋势分析) + 4(网格测试)"),
        # 组合 13
        ("6up", "momentum_13_6", "6U1D条件2（连续6天阳线）", True, True, False, "1(MA排列) + 3(趋势分析)"),
        ("6up1down", "momentum_13_61", "6U1D条件1（近10天6涨1跌）", True, True, False, "1(MA排列) + 3(趋势分析)"),
        # 组合 3（仅趋势分析）
        ("6up", "momentum_3_6", "6U1D条件2（连续6天阳线）", False, True, False, "3(趋势分析)"),
        ("6up1down", "momentum_3_61", "6U1D条件1（近10天6涨1跌）", False, True, False, "3(趋势分析)"),
        # 组合 34
        ("6up", "momentum_34_6", "6U1D条件2（连续6天阳线）", False, True, True, "3(趋势分析) + 4(网格测试)"),
        ("6up1down", "momentum_34_61", "6U1D条件1（近10天6涨1跌）", False, True, True, "3(趋势分析) + 4(网格测试)"),
        # 组合 14
        ("6up", "momentum_14_6", "6U1D条件2（连续6天阳线）", True, False, True, "1(MA排列) + 4(网格测试)"),
        ("6up1down", "momentum_14_61", "6U1D条件1（近10天6涨1跌）", True, False, True, "1(MA排列) + 4(网格测试)"),
        # 仅组合 1
        ("6up", "momentum_1_6", "6U1D条件2（连续6天阳线）", True, False, False, "1(MA排列)"),
        ("6up1down", "momentum_1_61", "6U1D条件1（近10天6涨1跌）", True, False, False, "1(MA排列)"),
        # 仅组合 4
        ("6up", "momentum_4_6", "6U1D条件2（连续6天阳线）", False, False, True, "4(网格测试)"),
        ("6up1down", "momentum_4_61", "6U1D条件1（近10天6涨1跌）", False, False, True, "4(网格测试)"),
        
        # ========== 容忍版6U1D指标（允许小跌<1.64%）==========
        # 完整组合 134 - 模糊版
        ("6up_tolerant", "momentum_134_6t", "6U1D条件2T（连续6天有效涨-模糊模式）", True, True, True, "1(MA排列) + 3(趋势分析) + 4(网格测试)"),
        ("6up1down_tolerant", "momentum_134_61t", "6U1D条件1T（近10天6有效涨1真跌-模糊模式）", True, True, True, "1(MA排列) + 3(趋势分析) + 4(网格测试)"),
        # 组合 13 - 模糊版
        ("6up_tolerant", "momentum_13_6t", "6U1D条件2T（连续6天有效涨-模糊模式）", True, True, False, "1(MA排列) + 3(趋势分析)"),
        ("6up1down_tolerant", "momentum_13_61t", "6U1D条件1T（近10天6有效涨1真跌-模糊模式）", True, True, False, "1(MA排列) + 3(趋势分析)"),
        # 组合 3 - 模糊版
        ("6up_tolerant", "momentum_3_6t", "6U1D条件2T（连续6天有效涨-模糊模式）", False, True, False, "3(趋势分析)"),
        ("6up1down_tolerant", "momentum_3_61t", "6U1D条件1T（近10天6有效涨1真跌-模糊模式）", False, True, False, "3(趋势分析)"),
        # 组合 34 - 模糊版
        ("6up_tolerant", "momentum_34_6t", "6U1D条件2T（连续6天有效涨-模糊模式）", False, True, True, "3(趋势分析) + 4(网格测试)"),
        ("6up1down_tolerant", "momentum_34_61t", "6U1D条件1T（近10天6有效涨1真跌-模糊模式）", False, True, True, "3(趋势分析) + 4(网格测试)"),
        # 组合 14 - 模糊版
        ("6up_tolerant", "momentum_14_6t", "6U1D条件2T（连续6天有效涨-模糊模式）", True, False, True, "1(MA排列) + 4(网格测试)"),
        ("6up1down_tolerant", "momentum_14_61t", "6U1D条件1T（近10天6有效涨1真跌-模糊模式）", True, False, True, "1(MA排列) + 4(网格测试)"),
        # 仅组合 1 - 模糊版
        ("6up_tolerant", "momentum_1_6t", "6U1D条件2T（连续6天有效涨-模糊模式）", True, False, False, "1(MA排列)"),
        ("6up1down_tolerant", "momentum_1_61t", "6U1D条件1T（近10天6有效涨1真跌-模糊模式）", True, False, False, "1(MA排列)"),
        # 仅组合 4 - 模糊版
        ("6up_tolerant", "momentum_4_6t", "6U1D条件2T（连续6天有效涨-模糊模式）", False, False, True, "4(网格测试)"),
        ("6up1down_tolerant", "momentum_4_61t", "6U1D条件1T（近10天6有效涨1真跌-模糊模式）", False, False, True, "4(网格测试)"),
    ]
    ...
    def _prepare_trend_df(self) -> pd.DataFrame:
        ...
        # 6U1D条件列名映射（支持新旧列名）
        mystic_col_aliases = {
            "6U1D_10天内有6连阳后1阴": ["6U1D_10天内有6连阳后1阴", "6U1D_近10天6涨1跌"],
            "6U1D_最近6天连续阳线": ["6U1D_最近6天连续阳线", "6U1D_连续6天阳线"],
            "6U1D_今天阴线且前6天连阳(回调)": ["6U1D_今天阴线且前6天连阳(回调)", "6U1D_今天为跌且7天刚好6涨1跌"],
            "6U1D_今天是第6天阳线(等待)": ["6U1D_今天是第6天阳线(等待)", "6U1D_今天是第6天阳线(追涨)", "6U1D_今天为涨且7天刚好6涨1跌"],
        }
    ...
    def _build_candidates(
        ...
        if mode == "6up1down":
            # 原版：严格6连阳后1阴
            col_name = "6U1D_10天内有6连阳后1阴" if "6U1D_10天内有6连阳后1阴" in trend_df.columns else "6U1D_近10天6涨1跌"
            mystic_mask = trend_df.get(col_name, pd.Series([False] * len(trend_df)))
        elif mode == "6up1down_tolerant":
            # 容忍版：6有效涨后1真跌
            col_name = "6U1D_10天内有6连涨后1跌(容忍小跌)"
            mystic_mask = trend_df.get(col_name, pd.Series([False] * len(trend_df)))
        elif mode == "6up_tolerant":
            # 容忍版：连续6天有效涨
            col_name = "6U1D_最近6天连续涨(容忍小跌)"
            mystic_mask = trend_df.get(col_name, pd.Series([False] * len(trend_df)))
        else:  # mode == "6up"
            # 原版：严格连续6天阳线
            col_name = "6U1D_最近6天连续阳线" if "6U1D_最近6天连续阳线" in trend_df.columns else "6U1D_连续6天阳线"
            mystic_mask = trend_df.get(col_name, pd.Series([False] * len(trend_df)))
        ...
        if mode in ["6up1down_tolerant", "6up_tolerant"]:
            # 容忍版的优先级列
            callback_col = "6U1D_今天小跌且前6天连涨(买入机会)"
            wait_col = "6U1D_今天是第6天涨(等待)"
        else:
            # 原版的优先级列
            callback_col = "6U1D_今天阴线且前6天连阳(回调)" if "6U1D_今天阴线且前6天连阳(回调)" in trend_df.columns else "6U1D_今天为跌且7天刚好6涨1跌"
            wait_col = "6U1D_今天是第6天阳线(等待)" if "6U1D_今天是第6天阳线(等待)" in trend_df.columns else ("6U1D_今天是第6天阳线(追涨)" if "6U1D_今天是第6天阳线(追涨)" in trend_df.columns else "6U1D_今天为涨且7天刚好6涨1跌")
        ...
        if include_steady:
            ...
            candidates["MAxRSIx6U1D_是否信号"] = code_series.astype(str).map(lambda c: bool(self.steady_map.get(c, False)))
            candidates = candidates[candidates["MAxRSIx6U1D_是否信号"]]
            code_series, code_col = self._get_code_series(candidates)
    ...
    def _save_csv(self, candidates: pd.DataFrame, path: Path):
        ...
        out_cols = [
            ...
            # 原版6U1D指标
            "6U1D_近10天6涨1跌", "6U1D_连续6天阳线",
            "6U1D_10天内有6连阳后1阴", "6U1D_最近6天连续阳线",
            # 容忍版6U1D指标
            "6U1D_10天内有6连涨后1跌(容忍小跌)", "6U1D_最近6天连续涨(容忍小跌)",
            "6U1D_今天小跌且前6天连涨(买入机会)", "6U1D_今天是第6天涨(等待)",
            # 优先级和信号
            "回调买点", "等待买点",
            "趋势跟随_是否信号", "上升回撤_是否信号", "波动收缩突破_是否信号",
            "MAxRSIx6U1D_是否信号", "网格突破_是否信号",
        ]
    ...
    def _save_report(
        ...
        lines = [
            f"# 6U1D联合筛选（{strategy_name}）报告 ({ts})",
            "",
            f"- 策略: {strategy_name}",
            f"- 6U1D条件: {mode_label}",
            f"- 组合条件: {combo_label}",
